  ...
  return (
    <div className="flex">
      ...
      <div className = "absolute p-8 text-2xl text-gray-600 font-semibold top-3/4 w-full z-[-1]">
        ...
        <div  className="w-full font-bold text-4xl cursor-pointer font-[Poppins] absolute  flex items-center justify-center z-[-1] bg-[url('https://i.pinimg.com/originals/61/af/fd/61affdbb6a81a5baba8925543e46ff82.jpg')] h-1/5 bg-center bg-cover">           
         <Form/></div>
        <Getdata/>
        <br/>
